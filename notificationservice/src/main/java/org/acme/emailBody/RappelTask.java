...
public class RappelTask {
    ...
    public String bodyEmail(String taskname, Integer projetId) {
        body = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional //EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>"
                ...
                + "<meta content='IE=edge' http-equiv='X-UA-Compatible'/>" + "<!--<![endif]-->" + "<title></title>"
                + "<!--[if !mso]><!-->"
                ...
                + "" + "            .mobile_hide {" + "                min-height: 0px;"
                + "                max-height: 0px;" + "                max-width: 0px;"
                + "                display: none;" + "                overflow: hidden;"
                + "                font-size: 0px;" + "            }" + "" + "            .desktop_hide {"
                + "                display: block !important;" + "                max-height: none !important;"
                + "            }" + "        }" + "    </style>" + "<style id='menu-media-query' type='text/css'>"
                + "        @media (max-width: 700px) {" + "            .menu-checkbox[type='checkbox']~.menu-links {"
                ...
                + "            #menunej32o~div label {" + "                border-radius: 0% !important;"
                + "            }" + "" + "            #menunej32o:checked~.menu-links {"
                + "                background-color: #000000 !important;" + "            }" + ""
                + "            #menunej32o:checked~.menu-links a {" + "                color: #ffffff !important;"
                + "            }" + "" + "            #menunej32o:checked~.menu-links span {"
                + "                color: #ffffff !important;" + "            }" + "        }" + "    </style>"
                + "<style id='icon-media-query' type='text/css'>" + "        @media (max-width: 700px) {"
                ...
                + "<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->" + "</div>" + "</div>"
                ...
                + "</div>" + "</div>" + "<!--[if mso]></td></tr></table><![endif]-->" + "<!--[if (!mso)&(!IE)]><!-->"
                + "</div>" + "<!--<![endif]-->" + "</div>" + "</div>"
                + "<!--[if (mso)|(IE)]></td></tr></table><![endif]-->"
                + "<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->" + "</div>" + "</div>"
                + "</div>" + "<div style='background-color:transparent;'>"
                ...
                + "<p style='margin: 0; text-align: center; line-height: 1.2; word-break: break-word; font-size: 46px; mso-line-height-alt: 55px; margin-top: 0; margin-bottom: 0;'><span style='font-size: 46px;'>"
                + taskname + " is due in a day </span></p>" + "</div>" + "</div>"
                ...
                + "<!--[if mso]></td></tr></table><![endif]-->" + "</div>" + "</td>" + "</tr>" + "</table>"
                + "<table border='0' cellpadding='0' cellspacing='0' class='divider' role='presentation' style='table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;' valign='top' width='100%'>"
                + "<tbody>" + "<tr style='vertical-align: top;' valign='top'>"
                + "<td class='divider_inner' style='word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;' valign='top'>"
                + "<table align='center' border='0' cellpadding='0' cellspacing='0' class='divider_content' height='30' role='presentation' style='table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-top: 0px solid transparent; height: 30px; width: 100%;' valign='top' width='100%'>"
                ...
                + "<!--<![endif]-->" + "</table>" + "</td>" + "</tr>" + "</table>" + "<!--[if (!mso)&(!IE)]><!-->"
                + "</div>" + "<!--<![endif]-->" + "</div>" + "</div>"
                + "<!--[if (mso)|(IE)]></td></tr></table><![endif]-->"
                + "<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->" + "</div>" + "</div>"
                + "</div>" + "<!--[if (mso)|(IE)]></td></tr></table><![endif]-->" + "</td>" + "</tr>" + "</tbody>"
                + "</table>" + "<!--[if (IE)]></div><![endif]-->" + "</body>" + "</html>";
        return body;
    }

    public String congratulationsBodyEmail(String taskname, Integer projetId) {
        body = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional //EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>"
                +
                ...
                + "<div style='color:#011776;font-family:TimesNewRoman, 'Times New Roman', Times, Beskerville, Georgia, serif;line-height:1.2;padding-top:35px;padding-right:10px;padding-bottom:0px;padding-left:10px;'>"
                + "<div class='txtTinyMce-wrapper' style='line-height: 1.2; font-size: 12px; font-family: TimesNewRoman, 'Times New Roman', Times, Beskerville, Georgia, serif; color: #011776; mso-line-height-alt: 14px;'>"
                + "<p style='margin: 0; text-align: center; line-height: 1.2; word-break: break-word; font-size: 42px; mso-line-height-alt: 50px; margin-top: 0; margin-bottom: 0;'><span style='font-size: 42px;'><strong>Congratulations</strong></span></p>"
                + "</div>" + "</div>" + "<!--[if mso]></td></tr></table><![endif]-->" + "<!--[if (!mso)&(!IE)]><!-->"
                + "</div>" + "<!--<![endif]-->" + "</div>" + "</div>"
                + "<!--[if (mso)|(IE)]></td></tr></table><![endif]-->"
                + "<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->" + "</div>" + "</div>"
                ...
                + "<div class='txtTinyMce-wrapper' style='line-height: 1.2; font-size: 12px; font-family: Georgia, Times, 'Times New Roman', serif; color: #011776; mso-line-height-alt: 14px;'>"
                + "<p style='margin: 0; text-align: center; line-height: 1.2; word-break: break-word; font-size: 46px; mso-line-height-alt: 55px; margin-top: 0; margin-bottom: 0;'><span style='font-size: 46px;'>"
                + "Congratulations You are the best member of the project ! </span></p>" + "</div>" + "</div>"
                + "<!--[if mso]></td></tr></table><![endif]-->" + "<!--[if (!mso)&(!IE)]><!-->" + "</div>"
                + "<!--<![endif]-->" + "</div>" + "</div>" + "<!--[if (mso)|(IE)]></td></tr></table><![endif]-->"
                + "<!--[if (mso)|(IE)]></td></tr></table></td></tr></table><![endif]-->" + "</div>" + "</div>"
                + "</div>" + "<div style='background-color:transparent;'>"
