...
public class NotificationRessource {
    ...
    public List<Notifis> getAllNotifs() {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public Notifis getNotifByID(@PathParam("id") Long id) {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public List<Notifis> getLastThreeNotifs(@PathParam("idRecever") String idRecever) {
    ...
    public Status markAllAsRead(@PathParam("iduser") String iduser) {
        ...
        List<Notifis> newNotifsList = notificationRepository.find("idRecever", iduser).list();

        for (Notifis notifis : newNotifsList) {
    ...
    public Status markAsUnRead(@PathParam("idnotif") Long idnotif) {
        Notifis notifis = notificationRepository.findById(idnotif);
