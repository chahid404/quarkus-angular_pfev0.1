INSERT INTO project(createdDate,creator,deadline,description,documents,membres, name,progress,projectSettings,startDate,status,subProject,tags,tasks) VALUES ( '2021-03-06', 'chahid','2021-03-06','first Project 1','file1.txt','chahid sami mah','Projet 1',55,'settings1','2021-03-06','active','Projet 1.1','dev , mobile','task 1');
INSERT INTO project(createdDate,creator,deadline,description,documents,membres, name,progress,projectSettings,startDate,status,subProject,tags,tasks) VALUES ('2021-03-06', 'sami','2021-03-06','first Project 2','file1.txt','sami chahid mah','Projet 3',15,'settings1','2021-03-06','blocked','Projet 2.1','java ,.net','task 6');
INSERT INTO project(createdDate,creator,deadline,description,documents,membres, name,progress,projectSettings,startDate,status,subProject,tags,tasks) VALUES ('2021-03-06', 'mah','2021-03-06','first Project 3','file1.txt','mah sami chahid','Projet 4',23,'settings4','2021-03-06','blocked','Projet 3.1','java ,.net','task 92');
INSERT INTO project(createdDate,creator,deadline,description,documents,membres, name,progress,projectSettings,startDate,status,subProject,tags,tasks) VALUES ('2021-03-06', 'yasmine','2021-03-06','first Project 4','file1.txt','sami yasmine','Projet 2',99,'settings3','2021-03-06','active','Projet 4.1','java ,.net','task 12');
